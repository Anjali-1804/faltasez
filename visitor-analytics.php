...
<head>
    ...
    <!-- Page Title -->
    <title><?php echo $gbl_row["org_name"]; ?> | Visitor Analytics</title>
...
<body>
            ...
            <div class="container">
                <div class="title-box">
                    <ol class="breadcrumb">
                        ...
                        <li class="active" aria-current="page">Visitor Analytics</li>
                    </ol>
                    <h1>Visitor <span>Analytics</span></h1>
                </div>
            </div> <!-- end container -->
        </section>
        <!-- end page-title -->
                        ...
                        <div class="row">
                            <div class="col col-md-12">
                                <div class="about-event">
                                    ...
                                    <div class="content">
                                        <iframe src="https://clicky.com/stats/wp-iframe?site_id=101401683&sitekey=9b003027a1f1b994" height="1000px" width="100%"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row -->
    ...
    <!-- Clicky Visitor Analytics -->
    <script async src="//static.getclicky.com/101401683.js"></script>
</body>
</html>
