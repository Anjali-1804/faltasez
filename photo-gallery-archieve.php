...
<head>
    ...
    <!-- Page Title -->
    <title><?php echo $gbl_row["org_name"]; ?> | Gallery Archive</title>
    ...
    <div class="page-wrapper event-single-page">
      ...
      <!-- end of header -->
            ...
            <div class="container">
                <div class="title-box">
                    <ol class="breadcrumb">
                        ...
                        <li class="active" aria-current="page">Gallery Archive</li>
                    </ol>
                    <h1><span>Archived</span> Gallery</h1>
                </div>
            </div> <!-- end container -->
        </section>
        <!-- end page-title -->
        ...
        <section class="gallery-4col-content sortable-gallery gallery section-padding-lesser-top">
            <h2 class="hidden">Archived Gallery</h2>
            <div class="container">
                <div class="row">
                      <?php
