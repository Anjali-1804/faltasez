   ...
   // Small navigation functionality
    ...
    function startUiAfterLoad() {
        ...
        if ($(".home-style-four .hero-title").length) {
            $(".home-style-four .hero-title").addClass("active-hero-title");
        }
        if ($(".home-style-five .main-banar .banar-title").length) {
            $(".home-style-five .main-banar .banar-title").addClass("active-banar-title");
        }
    }

    function preloader() {
        if ($(".preloader").length && $(".preloader").is(":visible")) {
            $(".preloader").delay(100).fadeOut(500, startUiAfterLoad);
        } else {
            startUiAfterLoad();
        }
    }
    ...
    function map() {
        ...
        var myLatLng = new google.maps.LatLng(22.274700,88.098701);
        var mapProp = {
            center: myLatLng,
            zoom: 11,
            scrollwheel: false,
    ...
    if ($("#feedback-form").length) {   
       ...
       var email = $("#email").val();
       var notes = $("#notes").val();
       var frmdata = "name="+name+"&email="+email+"&notes="+notes;
       ...
       if(name === "" || email === "" || notes === "")
       {
           ...
           if(response == 1) {
                $( "#fsuccess").show().slideDown( "slow" );
                 setTimeout(function() {
                $( "#fsuccess").show().slideUp( "slow" );
                }, 3000);
                $("#feedback-form")[0].reset();
           }
           else {
               $( "#ferror").show().slideUp( "slow" );
                setTimeout(function() {
                $( "#ferror").show().slideUp( "slow" );
                }, 3000);
               $("#feedback-form")[0].reset();
