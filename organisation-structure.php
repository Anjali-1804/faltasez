...
<head>
    ...
    <!-- Page Title -->
    <title><?php echo $gbl_row["org_name"]; ?> | Organisational Structure</title>
            ...
            <div class="container">
                <div class="title-box">
                    <ol class="breadcrumb">
                        ...
                        <li class="active" aria-current="page">Organisational Structure</li>
                    </ol>
                    <h1><span>FSEZ </span>Organisation</h1>
                </div>
            </div> <!-- end container -->
        </section>
        <!-- end page-title -->
                        ...
                        <div class="row">
                            <div class="col col-md-12">
                                <div class="about-event">
                                    <div class="content ">
                                        <img src="images/org_structure.png" alt="organisational structure" class="img img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row -->
