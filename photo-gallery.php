            ...
            <div class="container">
                <div class="row">
                    <div class="col col-lg-12">
                       <?php
                       $glsql = "select * from fsez_gallery_images where category_id = 13 and status = 1 order by added_on desc";
                ...
                <div class="row">
                    <a href="photo-gallery-archieve.php" class="btn theme-btn join">Go To Archieve</a>
                </div>
            </div> <!-- end container -->
        </section>
        <!-- end gallery-st2 -->
