...
<head>
    ...
    <!-- Page Title -->
    <title><?php echo $gbl_row["org_name"]; ?> | Other Links</title>
    ...
    <div class="page-wrapper event-single-page">
      ...
      <!-- end of header -->
        ...
        <section class="repo page-title">
            ...
            <div class="container">
                <div class="title-box">
                    <h1>Other <span>Links</span></h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php">Home</a></li>
                        <li class="active" aria-current="page">Other Links</li>
                    </ol>
                </div>
            </div> <!-- end container -->
        </section>
                          ...
                          <?php include("includes/sidebar.php"); ?> <!-- end col -->
                            ...
                            <div class="col col-md-9">
                                <div class="about-event">
                                    <h2>View/Download SEZ Rules</h2>
                                    <div class="content">
                                    <li><i class="fa fa-download"></i><a href="repo/sez-files/SEZ Rules 2010.pdf" target="_blank">SEZ Rules 2010</a></li>
                                    </div>
                                    <h3>Latest Update On SEZ Rules</h3>
                                    <div class="content">
